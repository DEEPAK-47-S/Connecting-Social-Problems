...
export default function AdminDashboardPage() {
 ...
 <div className={`max-w-md w-full rounded-3xl p-6 shadow-md border bg-white border-zinc-200 dark:bg-zinc-900/75 dark:border-zinc-800`}>
 ...
 <option key={d} value={d} className={`bg-white shadow-sm border border-gray-200 dark:bg-zinc-900/75`}>{d}</option>
 ))}
 </select>
 </div>
 ...
 <option key={k} value={k} className={`bg-white shadow-sm border border-gray-200 dark:bg-zinc-900/75`}>{STATUS_BADGES[k].label}</option>
 ))}
 </select>
 </div>
 ...
 <p className={`font-mono text-zinc-900 dark:text-zinc-100 bg-white shadow-sm border border-gray-200 dark:bg-zinc-900/75 p-2 rounded-xl mt-1 text-[11px] select-all`}>{inspectPost.id}</p>
 </div>
 ...
 <p className={`text-zinc-900 dark:text-zinc-100 mt-1 leading-relaxed bg-white shadow-sm border border-gray-200 dark:bg-zinc-900/75 p-3 rounded-xl whitespace-pre-line`}>{inspectPost.description}</p>
 </div>
 ...
 <div className={`p-3 bg-white shadow-sm border border-gray-200 dark:bg-zinc-900/75 rounded-xl`}>
